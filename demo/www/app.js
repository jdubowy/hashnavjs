(function () {
    ...
    hashnav.add_route("/baz/?", {top_level_tab_index: 2}, function(a){
        return '<div style="background-color: orange;">Baz</div>' +
            '<p>At quo iisque integre eleifend, duo cu ipsum consul iriure. An nemore ' +
            'noluisse pro, ea pericula democritum abhorreant sit, paulo solet omnesque ' +
            'sea ne. Cu solum minim dignissim quo. Saperet debitis principes quo ne. Vis ' +
    ...
    hashnav.add_route("/foo/:first_name/?", {
        ...
        return '<div style="background-color: yellow;">Foo ' + first_name + '</div>' +
            ...
            'eleifend volutpat. Nec in scripta appareat. Mucius latine nec ad, te ' +
            'accusam molestie pri. Eam cu case solet nusquam. Sed et dicam corpora ' +
            'quaerendum, vis esse nibh euripidis ad, vis suas omnis tacimates ad. ' +
    ...
    hashnav.add_route("/foo/:first_name/:last_name/?", {
        ...
        return '<div style="background-color: purple;">Foo ' + first_name + ' ' + last_name +'</div>' +
            ...
            ' commodo omnesque nam. Ea diam placerat interpretaris vix, ex error laudem ' +
